...
extension Strings {
    ...
    public static let PasscodeNumberPad1Subtitle = NSLocalizedString("Passcode.NumberPad.1.Subtitle", comment: "")
    public static let PasscodeNumberPad2Subtitle = NSLocalizedString("Passcode.NumberPad.2.Subtitle", comment: "")
    public static let PasscodeNumberPad3Subtitle = NSLocalizedString("Passcode.NumberPad.3.Subtitle", comment: "")
    public static let PasscodeNumberPad4Subtitle = NSLocalizedString("Passcode.NumberPad.4.Subtitle", comment: "")
    public static let PasscodeNumberPad5Subtitle = NSLocalizedString("Passcode.NumberPad.5.Subtitle", comment: "")
    public static let PasscodeNumberPad6Subtitle = NSLocalizedString("Passcode.NumberPad.6.Subtitle", comment: "")
    public static let PasscodeNumberPad7Subtitle = NSLocalizedString("Passcode.NumberPad.7.Subtitle", comment: "")
    public static let PasscodeNumberPad8Subtitle = NSLocalizedString("Passcode.NumberPad.8.Subtitle", comment: "")
    public static let PasscodeNumberPad9Subtitle = NSLocalizedString("Passcode.NumberPad.9.Subtitle", comment: "")
