...
class PasscodeController: UIViewController {
    ...
    @IBAction func button0Touched(_ sender: Any) {
        handleButtonTouched(value: Strings.PasscodeNumberPad0)
    }

    @IBAction func button1Touched(_ sender: Any) {
        handleButtonTouched(value: Strings.PasscodeNumberPad1)
    }

    @IBAction func button2Touched(_ sender: Any) {
        handleButtonTouched(value: Strings.PasscodeNumberPad2)
    }

    @IBAction func button3Touched(_ sender: Any) {
        handleButtonTouched(value: Strings.PasscodeNumberPad3)
    }

    @IBAction func button4Touched(_ sender: Any) {
        handleButtonTouched(value: Strings.PasscodeNumberPad4)
    }

    @IBAction func button5Touched(_ sender: Any) {
        handleButtonTouched(value: Strings.PasscodeNumberPad5)
    }

    @IBAction func button6Touched(_ sender: Any) {
        handleButtonTouched(value: Strings.PasscodeNumberPad6)
    }

    @IBAction func button7Touched(_ sender: Any) {
        handleButtonTouched(value: Strings.PasscodeNumberPad7)
    }

    @IBAction func button8Touched(_ sender: Any) {
        handleButtonTouched(value: Strings.PasscodeNumberPad8)
    }

    @IBAction func button9Touched(_ sender: Any) {
        handleButtonTouched(value: Strings.PasscodeNumberPad9)
    }
    ...
    private func handleButtonTouched(value: String) {
