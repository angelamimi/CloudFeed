...
final class ProfileController: UIViewController {
    ...
    func showActivityIndicator() {
        ...
        if navigationItem.rightBarButtonItems?.count == 1 {
            indicator = navigationItem.rightBarButtonItems?[0].customView as? UIActivityIndicatorView
        }
...
extension ProfileController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.section == 0 && indexPath.item == 0 {
            ...
            guard let cell = tableView.dequeueReusableCell(withIdentifier: "AvatarCell", for: indexPath) as? AvatarCell else { return UITableViewCell() }
