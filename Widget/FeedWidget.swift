...
struct FeedWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        AppIntentConfiguration(kind: kind, provider: FeedImageProvider()) { entry in
            FeedWidgetEntryView(entry: entry)
                .containerBackground(.background, for: .widget)
        }
        .contentMarginsDisabled()
        .configurationDisplayName(LocalizedStringResource("Widget.Feed.Config.Title"))
        .description(LocalizedStringResource("Widget.Feed.Config.Description"))
