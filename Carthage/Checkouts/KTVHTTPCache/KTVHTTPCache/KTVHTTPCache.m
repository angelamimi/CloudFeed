...
+ (NSInteger)downloadStatusCode:(NSURL *)url
{
    NSDictionary *statusCodeDictionary = [KTVHCDownload download].statusCodeDictionary;
    NSInteger statusCode = [statusCodeDictionary[url] integerValue];
    return statusCode;
}
